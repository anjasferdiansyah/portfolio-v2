...
import projectImage4_1 from "@/assets/project4-1.png";
import projectImage4_2 from "@/assets/project4-2.png";
...
const listProjects: Project[] = [
  ...
  },
  {
    ...
    year: "2024",
    desc: "My personal portfolio website, built with Next.js and Sass.",
    tech: ["NextJS", "Sass", "Framer Motion"],
    image: [projectImage4_1, projectImage4_2],
  },
  {
    name: "Recipe App",
    year: "2024",
